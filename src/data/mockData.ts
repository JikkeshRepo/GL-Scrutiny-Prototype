...
export const mockAccounts: GLAccount[] = [
  {
    ...
    transactions: [
      { id: 'tx_001', date: '2023-09-16', description: 'Delta Airlines', reference: 'EXP-9921', amount: 1250.00, violatedRules: ['R001'], isFlagged: true },
      { id: 'tx_002', date: '2023-09-17', description: 'Ritz Carlton', reference: '', amount: 850.00, violatedRules: ['R001', 'R002'], isFlagged: true },
      { id: 'tx_003', date: '2023-09-21', description: 'Uber Trip', reference: 'EXP-9945', amount: 45.00, violatedRules: [], isFlagged: false },
      { id: 'tx_004', date: '2023-09-22', description: 'Client Dinner', reference: '', amount: 620.00, violatedRules: ['R002'], isFlagged: true },
    ]
  },
  {
    id: 'acc_7200',
    ...
    transactions: [
      { id: 'tx_101', date: '2023-09-05', description: 'Legal Consultaion', reference: 'INV-1002', amount: 15000.00, violatedRules: [], isFlagged: false },
      { id: 'tx_102', date: '2023-09-10', description: 'Audit Retainer', reference: '', amount: 50000.00, violatedRules: ['R002', 'R004'], isFlagged: true },
      { id: 'tx_103', date: '2023-09-10', description: 'Audit Retainer', reference: '', amount: 50000.00, violatedRules: ['R003'], isFlagged: true },
    ]
  },
  {
    id: 'acc_1100',
    ...
    transactions: [
      { id: 'tx_201', date: '2023-09-01', description: 'Transfer to Payroll', reference: 'TRN-101', amount: 250000.00, violatedRules: [], isFlagged: false },
      { id: 'tx_202', date: '2023-09-28', description: 'Wire Transfer', reference: '', amount: 100000.00, violatedRules: ['R002', 'R004'], isFlagged: true },
    ]
  },
  {
    id: 'acc_5100',
    ...
    transactions: [
      { id: 'tx_301', date: '2023-09-15', description: 'Supplier Payment A', reference: 'INV-888', amount: 45000.00, violatedRules: [], isFlagged: false },
      { id: 'tx_302', date: '2023-09-15', description: 'Supplier Payment A', reference: 'INV-888', amount: 45000.00, violatedRules: ['R003'], isFlagged: true },
    ]
  }
];
